...
public class LoginController implements Initializable {
    ...
    private static String database = "e1309";
...
//        String password = txtPass.getText();
        ...
        if (rs.next()) {
            ...
            try {
                ...
                ResultSet rs_ip = dh.getData("SELECt * FROM plc_ip WHERE id='1'", connect);
                String ip_plc ="";
                if(rs_ip.next()){
                    ip_plc = rs_ip.getString("ip");
                }
                String user_type = rs.getString("user_type");
                InetAddress geek = InetAddress.getByName(ip_plc);
